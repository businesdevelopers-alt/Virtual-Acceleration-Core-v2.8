...
export const INITIAL_ROADMAP: LevelData[] = [
  ...
  { id: 2, title: 'هيكلة نموذج العمل', description: 'بناء مخطط نموذج العمل التجاري (Business Model Canvas) وتحديد قنوات الإيرادات المستدامة والشركاء الرئيسيين.', icon: '📐', imageUrl: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=600', isLocked: true, isCompleted: false, customColor: 'emerald' },
