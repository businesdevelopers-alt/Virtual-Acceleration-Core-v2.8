...
export const INITIAL_ROADMAP: LevelData[] = [
  ...
  { id: 2, title: 'هيكلة نموذج العمل', description: 'بناء نموذج العمل التجاري (Business Model Canvas) وتحديد القنوات الرئيسية للإيرادات والموارد الأساسية.', icon: '📐', imageUrl: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=600', isLocked: true, isCompleted: false, customColor: 'emerald' },
